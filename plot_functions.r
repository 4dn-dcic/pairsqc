...
plot_orientation_proportion_vs_distance <- function(x, xlim=c(2,4), plt=c(0.2,0.8,0.2,0.8), no_xlabel=FALSE){
  par(plt=plt)
...
plot_orientation_log10count_vs_distance <- function(x, xlim=c(2,4), plt=c(0.2,0.8,0.2,0.8), no_xlabel=FALSE){
  par(plt=plt)
  ylim=c(0,max(x[,7:10]))
...
plot_contact_probability_vs_distance <- function(x, xlim=c(3.2,8), plt=c(0.2,0.8,0.2,0.8), no_xlabel=FALSE) {
  par(plt=plt)
  ylim=range(x[,18])
